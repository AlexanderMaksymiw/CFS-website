...
export default function HeroOverlay() {
  ...
  return (
    <div className="absolute inset-0 z-20 flex flex-col  justify-center bg-slate-900/60 md:bg-slate-900/10 text-white mx-auto pt-26 md:pt-26 lg:pt-0 h-[650px] md:h-[850px]">
      <div>
