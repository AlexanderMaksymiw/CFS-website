...
export default function Location() {
  return (
    <section className="flex flex-col gap-4 pb-20 px-6 md:px-30 bg-amber-400">
      {/* Title Block */}
      <div>
        <h3 className="text-6xl md:text-7xl font-black mt-10 tracking-tight uppercase leading-[0.9] text-black">
          WE'LL SEE <br />
      ...
      <div className="flex flex-col md:flex-row gap-12 md:gap-20 items-start mt-8">
        ...
        <div className="relative w-full md:w-[40%] flex flex-col pt-2">
          ...
          <div className="mt-16">
            ...
            <div className="flex flex-col">
              <p className="text-xl md:text-2xl font-mono font-black tracking-tight text-black">
        ...
        <div className="relative w-full md:w-[60%] h-87.5 md:h-112.5 md:-mt-10 overflow-hidden rounded-[2.5rem]">
          <iframe
