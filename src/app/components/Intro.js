...
export default function Intro({ eyebrow, title, content }) {
  return (
    <div className="relative z-40 w-full bg-slate-700 overflow-hidden">
      <div className="relative h-[70vh] md:h-[90vh] w-full border-y border-white/5">
        <video
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-30 text-white">
          <div className="max-w-4xl space-y-6">
            ...
            <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tight leading-[0.9] italic antialiased">
              {title}
            </h2>
