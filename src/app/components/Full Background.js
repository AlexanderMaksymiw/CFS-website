...
export default function FullBackground({ children }) {
  return (
    <div className="relative h-[100vh] w-full overflow-hidden bg-slate-800">
      <Image
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-slate-900 via-slate-200/10 to-transparent z-10" />
